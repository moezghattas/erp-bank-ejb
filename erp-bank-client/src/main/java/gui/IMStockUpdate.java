...
public class IMStockUpdate extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IMStockUpdate frame = new IMStockUpdate();
	...
	public IMStockUpdate() {
		...
		lblNewLabel_1.setBounds(45, 110, 78, 14);
		...
		lblNewLabel_3.setBounds(45, 181, 78, 14);
		...
		textField.setBounds(147, 107, 86, 20);
		contentPane.add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(147, 143, 86, 20);
		contentPane.add(textField_1);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField();
		textField_2.setBounds(147, 178, 86, 20);
		contentPane.add(textField_2);
		textField_2.setColumns(10);
		
		textField_3 = new JTextField();
		textField_3.setBounds(147, 210, 86, 20);
		...
		lblNewLabel_5.setBounds(408, 129, 78, 14);
		...
		textField_5.setBounds(147, 245, 86, 20);
		contentPane.add(textField_5);
		
		textField_6 = new JTextField();
		textField_6.setColumns(10);
		textField_6.setBounds(147, 284, 86, 20);
